	...
	<header>
					...
					<div class="menu-desktop">
						<ul class="main-menu">
							<li class="active-menu">
								...
								<ul class="sub-menu">
									<li><a href="{{asset('lph/index.html')}}">Homepage 1</a></li>
									<li><a href="{{asset('lph/home-02.html')}}">Homepage 2</a></li>
									<li><a href="{{asset('lph/home-03.html')}}">Homepage 3</a></li>
								</ul>
							</li>

							<li>
								<a href="{{asset('lph/product.html')}}">Shop</a>
							</li>

							<li class="label1" data-label1="hot">
								<a href="{{asset('lph/shoping-cart.html')}}">Features</a>
							</li>

							<li>
								<a href="{{asset('lph/blog.html')}}">Blog</a>
							</li>

							<li>
								<a href="{{asset('lph/about.html')}}">About</a>
							</li>

							<li>
								<a href="{{asset('lph/contact.html')}}">Contact</a>
							</li>
						</ul>
					</div>	
		...
		<div class="wrap-header-mobile">
			...
			<div class="logo-mobile">
				<a href="{{asset('lph/index.html')}}"><img src="{{asset('lph/images/icons/logo-01.png')}}" alt="IMG-LOGO"></a>
			</div>
		...
		<div class="menu-mobile">
			...
			<ul class="main-menu-m">
				<li>
					<a href="{{asset('lph/index.html')}}">Home</a>
					<ul class="sub-menu-m">
						<li><a href="{{asset('lph/index.html')}}">Homepage 1</a></li>
						<li><a href="{{asset('lph/home-02.html')}}">Homepage 2</a></li>
						<li><a href="{{asset('lph/home-03.html')}}">Homepage 3</a></li>
			...
			<div class="header-cart-content flex-w js-pscroll">
				<ul class="header-cart-wrapitem w-full">
					<li class="header-cart-item flex-w flex-t m-b-12">
						<div class="header-cart-item-img">
							<img src="{{asset('lph/images/item-cart-01.jpg')}}" alt="IMG">
						</div>
					...
					<li class="header-cart-item flex-w flex-t m-b-12">
						<div class="header-cart-item-img">
							<img src="{{asset('lph/images/item-cart-02.jpg')}}" alt="IMG">
						</div>
					...
					<li class="header-cart-item flex-w flex-t m-b-12">
						<div class="header-cart-item-img">
							<img src="{{asset('lph/images/item-cart-03.jpg')}}" alt="IMG">
						</div>
				...
				<div class="w-full">
					...
					<div class="header-cart-buttons flex-w w-full">
						<a href="{{asset('lph/shoping-cart.html')}}" class="flex-c-m stext-101 cl0 size-107 bg3 bor2 hov-btn3 p-lr-15 trans-04 m-r-8 m-b-10">
							View Cart
						</a>

						<a href="{{asset('lph/shoping-cart.html')}}" class="flex-c-m stext-101 cl0 size-107 bg3 bor2 hov-btn3 p-lr-15 trans-04 m-b-10">
							Check Out
						</a>
					</div>
				</div>
